...
export default function Calculator() {
  ...
  useEffect(() => {
    ...
    const finalPrice = basePricePerGram * multiplier;

    setPricePerGram(finalPrice);
    setTotal(finalPrice * numericWeight);
    setTierLabel(label);
  }, [weight, karat, prices]);
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-8 text-gray-900 bg-white">
      ...
      <div className="bg-gray-100 border border-gray-200 p-6 rounded-xl mt-6 space-y-3">
        <p className="text-sm text-gray-700">Your Rate</p>
        ...
        {tierLabel && <p className="text-sm text-gray-600">{tierLabel}</p>}

        <p className="text-sm text-gray-600">
          Buying rates update frequently based on live international gold market
          conditions.
        </p>
        ...
        {total > 0 && (
          <div className="pt-4 border-t border-gray-300 mt-3">
            <p className="text-sm mb-2">Ready to sell this gold?</p>
      ...
      {showInstall && (
        <div className="bg-white border border-gray-200 rounded-xl p-5 mt-6">
          <h2 className="text-lg font-semibold mb-2">Install Goldzone App</h2>

          <p className="text-sm text-gray-700 mb-4">
            Install the app for faster access to the calculator and gold selling
            service.
          </p>
